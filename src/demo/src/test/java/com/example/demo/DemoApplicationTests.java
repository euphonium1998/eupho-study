...
class DemoApplicationTests {
    ...
    void selectProductTest() {
        List<Map<String,String>> productList = productMapper.selectProductByPrice(new BigDecimal("10.00"));
        log.debug("Products with price greater than 10.00 = {}",productList);
    }
